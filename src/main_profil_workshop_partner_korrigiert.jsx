...
function ProfileEditor({
  ...
  useEffect(() => {
    ...
    async function loadWorkshopData() {
      ...
      // Alle Workshops berücksichtigen, an denen der Nutzer
      // entweder selbst eine Tanzpartnersuche gestartet hat ODER
      // bereits eine Tanzpartnerschaft hat.
      // Wichtig: Ein bestehendes Paar kann auch dann existieren,
      // wenn kein eigener Eintrag mehr in workshop_interests vorhanden ist.
      const ids = [
        ...new Set([
          ...(interests || [])
            .map(x => x.workshop_id)
