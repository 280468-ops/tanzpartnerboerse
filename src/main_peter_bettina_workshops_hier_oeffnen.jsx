              ...
              return (
                <article className="workshop-modern-card" key={w.id}>
                  ...
                  {paired ? (
                    ...
                    <>
                      <div id={`workshop-actions-${w.id}`} className="workshop-actions">
                        {!interested && (
                          <select
                      ...
                      {openSeekers.length > 0 && (
                        <div className="seekers" style={{ marginTop: 12 }}>
                          ...
                          {openSeekers.map(p => (
                            <div className="row seeker" key={p.id}>
                              ...
                              <button
                                className="primary"
                                onClick={() => contactForWorkshop(w.id, p.id)}
                              >
                                Kontakt aufnehmen
                              </button>
                            </div>
                ...
                <div className="workshop-modal-actions">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      document.getElementById(`workshop-actions-${openWorkshop.id}`)?.scrollIntoView({
                        behavior: "smooth",
                        block: "center"
                      });
                    }}
