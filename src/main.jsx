...
function Dashboard({ session }) {
  ...
  async function loadUnreadMessages() {
    ...
    if (error) {
      console.warn("Ungelesene Nachrichten konnten nicht geladen werden:", error.message);
      return;
    }

    const lastRead = localStorage.getItem(
      `tpb_messages_read_${session.user.id}`
    );
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel(`dashboard-messages-${session.user.id}`)
      .on(
        "postgres_changes",
        {
          event: "INSERT",
...
function ProfileEditor({
  ...
  useEffect(() => {
    ...
    async function loadWorkshopData() {
      ...
      // „Meine Workshops“ muss alle Workshops enthalten, an denen
      // der Benutzer teilnimmt – auch dann, wenn die Teilnahme
      // inzwischen über eine Tanzpartnerschaft vorhanden ist.
      const ids = [
        ...new Set([
          ...(interests || [])
            .map(x => x.workshop_id)
            ...
            {contactLoading ? (
              ...
              <form onSubmit={save}>
                ...
                <label className="check">
                  ...
                  />
                  Ich möchte meine Kontaktdaten mit meinem Tanzpartner teilen
                </label>
...
function FaqContent({ openFaq, setOpenFaq }) {
  const sections = [
    {
      title: "So geht’s",
      items: [
        [
          ...
          "Öffne unten „Workshops“ und wähle den gewünschten Workshop aus. Dort siehst du Teilnehmer, die für diesen Workshop einen Tanzpartner suchen."
        ],
        [
          "🔎 Wie starte ich selbst eine Tanzpartnersuche?",
          "Öffne den gewünschten Workshop. Wenn du noch keinen Tanzpartner hast, kannst du dort deine Tanzpartnersuche starten und dein Niveau angeben."
        ],
        [
          "🤝 Wie nehme ich Kontakt zu einem passenden Teilnehmer auf?",
          "Wähle beim gewünschten Teilnehmer „Kontakt aufnehmen“. Die andere Person erhält eine Kontaktanfrage und kann diese annehmen oder ablehnen."
        ],
        [
          "✅ Was passiert, wenn die Anfrage angenommen wird?",
          "Wenn die Anfrage angenommen wird, wird für diesen Workshop eine Tanzpartnerschaft angelegt. Der Tanzpartner erscheint anschließend bei dem Workshop und in deinem Profil unter „Meine Workshops“."
        ]
      ]
    },
    {
      ...
      items: [
        [
          "📅 Wo finde ich die Workshops?",
          "Im Bereich „Workshops“ findest du die verfügbaren Workshops mit Datum, Uhrzeit und Veranstaltungsort."
        ],
        [
          "🎟️ Wie melde ich mich für einen Workshop an?",
          "Öffne den gewünschten Workshop und wähle „Workshop-Anmeldung öffnen“. Die eigentliche Anmeldung erfolgt über den hinterlegten Anmeldelink, zum Beispiel Eventfrog."
        ],
        [
          "📋 Wo sehe ich, an welchen Workshops ich teilnehme?",
          "Im Profil findest du unter „Meine Workshops“ deine Workshop-Teilnahmen. Wenn du dort bereits einen Tanzpartner gefunden hast, wird dessen Name ebenfalls angezeigt."
        ],
        [
          "👥 Kann ich für mehrere Workshops gleichzeitig einen Tanzpartner suchen?",
          "Ja. Die Tanzpartnersuche bezieht sich immer auf einen bestimmten Workshop. Für weitere Workshops kannst du jeweils eine eigene Suche starten."
        ]
      ]
    },
    {
      ...
      items: [
        [
          "⭐ Kann ich mein Tanzniveau angeben?",
          "Ja. Bei der Tanzpartnersuche kannst du dein Niveau für den jeweiligen Workshop angeben."
        ],
        [
          "🔍 Wer wird mir bei der Suche angezeigt?",
          "Dir werden Teilnehmer angezeigt, die für denselben Workshop eine Tanzpartnersuche gestartet haben und deren Profil sichtbar ist."
        ],
        [
          "❌ Kann ich meine Tanzpartnersuche wieder zurückziehen?",
          "Ja. Öffne den betreffenden Workshop und wähle „Tanzpartnersuche zurückziehen“."
        ],
        [
          "🔓 Kann ich eine bestehende Tanzpartnerschaft wieder auflösen?",
          "Ja. Bei einer bestehenden Partnerschaft kannst du die Tanzpartnerschaft wieder auflösen."
        ]
      ]
    },
    {
      title: "Kontakte & Datenschutz",
      items: [
        [
          "🔐 Sind meine E-Mail-Adresse und Telefonnummer öffentlich sichtbar?",
          "Nein. Deine Kontaktdaten werden nicht öffentlich in der Tanzpartnerbörse angezeigt."
        ],
        [
          "📱 Muss ich meine Kontaktdaten freigeben?",
          "Nein. Die Freigabe ist freiwillig und muss von dir aktiv ausgewählt werden. Deine Kontaktdaten werden nicht automatisch weitergegeben."
        ],
        [
          "💬 Funktioniert der Chat auch ohne Kontaktdaten?",
          "Ja. Du kannst mit deinem Tanzpartner ganz normal über den Chat schreiben, auch wenn du deine E-Mail-Adresse oder Telefonnummer nicht freigibst. So bleiben deine Kontaktdaten geschützt."
        ],
        [
          "📞 Wo kann ich meine Kontaktdaten ändern?",
          "Gehe im Profil auf „Kontaktdaten verwalten“. Dort kannst du deine hinterlegten Kontaktdaten und die Freigabe-Einstellung ändern."
        ],
        [
          "💬 Wo sehe ich meine Kontakte?",
          "Im Bereich „Kontakte“ findest du deine Kontaktanfragen und bereits bestätigten Kontakte. Dort kannst du – sofern für den Kontakt freigegeben – den Chat öffnen."
        ]
      ]
    },
    {
      ...
      items: [
        [
          "👤 Welche Angaben kann ich in meinem Profil ändern?",
          "Unter „Mein Profil“ kannst du unter anderem deinen Anzeigenamen, dein Alter, Geschlecht und – sofern gewünscht – deine Größe bearbeiten."
        ],
        [
          "⚙️ Was finde ich unter „Einstellungen“?",
          "Dort befinden sich die persönlichen Einstellungen deines Kontos. Je nach aktueller App-Version können dort unter anderem Benachrichtigungs- und weitere Kontoeinstellungen verwaltet werden."
        ],
        [
          "🔑 Wie ändere ich mein Passwort?",
          "Öffne im Profil „Passwort ändern“ und lege dort ein neues Passwort fest."
        ],
        [
          "🔑 Passwort vergessen – was mache ich?",
          "Nutze auf der Anmeldeseite „Passwort vergessen“ und folge den dort angezeigten Schritten."
        ]
      ]
    },
    {
      ...
      items: [
        [
          "🔄 Ein Workshop oder meine Tanzpartnerschaft wird nicht angezeigt.",
          "Lade die Seite zunächst neu und prüfe, ob du mit dem richtigen Konto angemeldet bist. Wenn der Eintrag weiterhin fehlt, wende dich an den Betreiber der Tanzpartnerbörse."
        ],
        [
          "📧 Ich bekomme keine E-Mail-Benachrichtigung.",
          "Prüfe zunächst deinen Spam- oder Junk-Ordner und kontrolliere deine hinterlegte E-Mail-Adresse. Wenn weiterhin keine Nachricht ankommt, wende dich an den Betreiber."
        ],
        [
          "🆘 Ich habe einen anderen Fehler.",
          "Beschreibe möglichst genau, was passiert ist, bei welchem Workshop der Fehler auftritt und welchen Schritt du vorher ausgeführt hast. So kann der Betreiber den Fehler schneller nachvollziehen."
        ]
      ]
    }
  ];
  ...
  return (
    <div style={{ background: "#faf8ff", padding: "6px 16px 16px" }}>
      <div
        style={{
      ...
      >
        Hier findest du die wichtigsten Antworten zur Nutzung der Tanzpartnerbörse.
      ...
      {sections.map((section, sectionIndex) => (
        <div
          key={section.title}
          style={{ marginTop: sectionIndex === 0 ? 0 : 10 }}
        >
          <div
            style={{
              padding: "8px 6px",
            ...
            {section.items.map(([question, answer], itemIndex) => {
              ...
              return (
                <div
                  ...
                  style={{
                    borderTop:
                      itemIndex === 0 ? 0 : "1px solid #eee"
                  }}
                >
                  <button
                    type="button"
                    onClick={() =>
                      setOpenFaq(open ? null : id)
                    }
                    style={{
                      width: "100%",
                      border: 0,
...
function Contacts({ userId }) {
  ...
  async function load() {
    ...
    // Letzte eingehende Nachricht je Kontakt laden, damit sofort sichtbar ist,
    // wer geschrieben hat und ob es eine neue Nachricht gibt.
    ...
    if (acceptedOtherIds.length > 0) {
      const { data: incomingMessages, error: messageError } =
        await supabase
          ...
          .in("sender_id", acceptedOtherIds)
          .order("created_at", { ascending: false });

      if (!messageError) {
        const latestMap = {};
        for (const message of incomingMessages || []) {
          if (!latestMap[message.sender_id]) {
            latestMap[message.sender_id] = message;
          }
        }
    ...
    return (
      <div className="contact-card" key={item.id}>
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {mode === "active" && latestMessages[otherId] && (
            <div
              style={{
                marginTop: 9,
                padding: "9px 11px",
            ...
            >
              ...
              >
                💬 {new Date(
                  latestMessages[otherId].created_at
                ).toLocaleString("de-DE", {
                  day: "2-digit",
                  month: "2-digit",
                  hour: "2-digit",
                  minute: "2-digit"
                })} · Nachricht von {contactName(item)}
              </div>
              <div
                style={{
                  marginTop: 3,
  ...
  return (
    <section className="contacts-modern">
      ...
      <div className="card">
        ...
        <p className="muted">
          Deine Telefonnummer und E-Mail-Adresse bleiben zunächst privat.
          Die Freigabe erfolgt nur, wenn du und dein Tanzpartner sie beide
          aktiv freigegeben habt.
        </p>

        <p className="muted" style={{ marginBottom: 0 }}>
          Wenn du deine Kontaktdaten freigeben möchtest, kannst du das
          jederzeit freiwillig in deinem <b>Profil</b> unter
          „Kontaktdaten verwalten“ aktivieren. Der Chat funktioniert auch
