  ...
  useEffect(() => {
    ...
    async function loadWorkshopData() {
      ...
      if (partnerIds.length) {
        ...
        // Falls die Sammelabfrage durch eine RLS-Regel nicht alle
        // Partner liefert, versuchen wir die fehlenden Profile einzeln.
        if (partnerProfiles.length < partnerIds.length) {
          const missingIds = partnerIds.filter(
            id =>
              !partnerProfiles.some(
                p => p.id === id
              )
          );

          for (const partnerId of missingIds) {
