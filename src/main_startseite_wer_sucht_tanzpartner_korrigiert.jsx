    ...
    <div className="app">
      <style>{`
        ...
        .home-dancers {
          ...
          height: 190px;
          border-radius: 50%;
          background: radial-gradient(circle, #f1e8ff 0%, #faf7ff 66%, transparent 70%);
          pointer-events: none;
        }
        ...
        .home-dancer-one::before,
        .home-dancer-two::before {
          content: "";
          position: absolute;
          width: 28px;
          height: 28px;
        ...
        .home-dancer-one::after,
        .home-dancer-two::after {
          content: "";
          position: absolute;
          width: 86px;
          height: 8px;
        ...
        .home-dancer-one { color: #6f35d9; }
        .home-dancer-two { color: #283046; }
        ...
        @media (max-width: 620px) {
          ...
          .home-hero { padding: 15px 15px 18px; border-radius: 20px; }
          .home-welcome { max-width: 61%; margin-top: 22px; }
          .home-dancers { right: -4px; top: 62px; width: 43%; height: 155px; }
          .home-dancer-one, .home-dancer-two { transform: scale(.82); transform-origin: top left; }
          .home-dancer-one { left: 18%; }
          .home-dancer-two { left: 42%; }
          .home-grid { gap: 9px; }
          .home-tile { min-height: 145px; padding: 12px 7px 10px; border-radius: 17px; }
          .home-icon { width: 49px; height: 49px; font-size: 24px; }
          .home-tile-subtitle { font-size: 11px; }
          .home-seeker-tile { padding: 14px; }
        }
      `}</style>
        ...
        <main className="home-page">
          <section className="home-hero">
            ...
            <div className="home-dancers" aria-hidden="true">
              <div className="home-dancer-one" />
              <div className="home-dancer-two" />
            </div>
          ...
          <div className="home-grid">
            <button className="home-tile" type="button" onClick={() => setTab("workshops")}>
              <div>
                ...
                <div className="home-tile-subtitle">Termine entdecken<br />und anmelden</div>
              </div>
            ...
            <button className="home-tile" type="button" onClick={openChat}>
              <div>
                ...
                <div className="home-tile-subtitle">Nachrichten mit<br />Kontakten</div>
              </div>
            ...
            <button className="home-tile" type="button" onClick={openContacts}>
              <div>
                ...
                <div className="home-tile-subtitle">Anfragen ansehen<br />und beantworten</div>
              </div>
            ...
            <button className="home-tile" type="button" onClick={openContacts}>
              <div>
                ...
                <div className="home-tile-subtitle">Deine Kontakte<br />anzeigen</div>
              </div>
            ...
            <button className="home-tile" type="button" onClick={() => setTab("faq")}>
              <div>
                ...
                <div className="home-tile-subtitle">Häufige Fragen<br />und Antworten</div>
              </div>
            ...
            <button className="home-tile" type="button" onClick={() => setTab("profil")}>
              <div>
                ...
                <div className="home-tile-subtitle">Profil ansehen<br />und bearbeiten</div>
              </div>
