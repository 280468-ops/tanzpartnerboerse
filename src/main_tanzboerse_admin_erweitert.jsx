...
function AdminPanel() {
  ...
  async function deleteUser(user) {
    const confirmed = confirm(
      `Nutzer "${user.display_name || "Ohne Namen"}" wirklich löschen?\n\n` +
      "Dabei wird das Profil aus der Datenbank entfernt. " +
      "Der eigentliche Login-Account muss anschließend über die sichere " +
      "Supabase-Admin-Funktion gelöscht werden."
    );
    ...
    if (error) {
      alert(
        ...
        error.message +
        "\n\nBitte prüfe die DELETE-RLS-Regel für profiles."
      );
      return;
    }
    ...
    alert(
      ...
      "Wichtig: Für das vollständige Löschen des Login-Kontos benötigen wir " +
      "noch die sichere Supabase-Edge-Function."
    );
  }
  ...
  async function deleteReportedUser(report) {
    ...
    if (error) {
      alert("Nutzer konnte nicht gelöscht werden: " + error.message);
      return;
    }
    ...
    await loadReports();
    alert("Profil wurde gelöscht und Meldung geschlossen.");
  }
