    ...
    <div className="app">
      <style>{`
        ...
        @media (max-width: 620px) {
          ...
          .home-dancers { right: -2px; top: 39px; width: 43%; height: 125px; }
          .home-dancer-one, .home-dancer-two { transform: scale(.67); transform-origin: top left; }
          .home-dancer-one { left: 18%; }
          .home-dancer-two { left: 42%; }
          .home-wave { bottom: 3px; height: 18px; }
          .home-grid { gap: 8px; }
