...
function Dashboard({ session }) {
  ...
  async function loadNewMessageCount() {
    try {
      ...
      // Offene eingehende Kontaktanfragen zählen – genau wie
      // ungelesene Chat-Nachrichten. Der Zähler wird regelmäßig
      // aktualisiert, damit eine neue Anfrage ohne Seiten-Reload
      // sichtbar wird.
      const {
  ...
  function openContacts() {
    // Das Öffnen der Kontakte markiert Nachrichten NICHT automatisch als gelesen.
    // Erst „Chat öffnen“ markiert die jeweilige Nachricht als gelesen.
    setTab("kontakte");
    loadNewMessageCount();
  }
